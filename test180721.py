...
#初始化
import pya
import paintlib20180724 as paintlib
...
paintlib.Interactive.show(painter5.brush)
paintlib.Interactive.show(paintlib.CavityPainter(pya.DPoint(2000000,24000),angle=180,widout=48000,widin=16000,bgn_ext=48000,end_ext=16000).brush)
