...
#画腔
painter3=paintlib.CavityPainter(pya.DPoint(0,24000),angle=180,widout=48000,widin=16000,bgn_ext=48000,end_ext=0000)
...
top.insert(pya.CellInstArray(cell2.cell_index(),pya.Trans(pya.Trans.R270)))
...
painter7=paintlib.CavityPainter(pya.DPoint(-450000,600000),angle=270,widout=48000,widin=16000,bgn_ext=0,end_ext=0)
...
tr=pya.DCplxTrans(1,-135,False,400000,-400000)
