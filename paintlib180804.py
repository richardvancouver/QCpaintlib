...
#        high=[-1,-1,1,1,    0,0]
    ...
    def Electrode_2(brush,wid=368000,length=360000,midwid=200000,midlength=200000,narrowlength=120000):
        ...
        return polygon1
    @staticmethod
    def Connection(x, widin=4000, widout=145000, linewid=5000, slength1=5000, slength2=17000, clength=50000, cwid=53000,y=0,angle=0):
#clength=30000,cwid=54000,widin=4000, widout=145000,linewid=5000,slength1=5000,slength2=17000,reverse=False
...
class CavityPainter(Painter):
    ...
    def Connection(self,clength=30000,cwid=53000,widin=4000,widout=145000,linewid=5000,slength1=5000,slength2=17000,reverse=False):
        assert((reverse==False and self.end_ext==0) or (reverse==True and self.bgn_ext==0))
        brush=self.brush.reversed() if reverse else self.brush
        polygon=BasicPainter.Connection(brush,widin=widin, widout=widout, linewid=linewid, slength1=slength1, slength2=slength2, clength=clength, cwid=cwid)
        self.regionlistout.append(polygon)
