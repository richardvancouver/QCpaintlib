...
#dcc=gettap(w=6.875*2*math.pi,bandwidth=0.2, epsilonef=epsiloneff,para3=0)
#tapagain=gettap(w=6.875*2*math.pi,bandwidth=0.2, epsilonef=epsiloneff)
#print("dc4again: %s"%dcc)
#print("tap4again: %s"%tapagain)



tr=testclassb.testclass

tapagain=tr.gettap(w=6.875*2*math.pi,bandwidth=0.2, epsilonef=epsiloneff, lenth=cavitylenp4)
print("tapagain:%s"%tapagain)

#dcc=gettap(w=6.875*2*math.pi,bandwidth=0.2, epsilonef=epsiloneff)
#print("dc4again: %s"%dcc)
#dcc=gettap(w=6.875*2*math.pi,bandwidth=0.2, epsilonef=epsiloneff,para3=0)
#tapagain=gettap(w=6.875*2*math.pi,bandwidth=0.2, epsilonef=epsiloneff, lenth=cavitylenp4)
#print("dc4again: %s"%dcc)
print("tap4again: %s"%tapagain)
