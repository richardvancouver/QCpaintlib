...
painterfeed1=paintlib.CavityPainter(pya.DPoint(-3200000+1380000,3100000+offsetz1-120000*2-2200000),angle=0,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
...
##############start the feedline backbone#############################################
painterfeed1=paintlib.CavityPainter(pya.DPoint(-3200000+1380000,3100000+offsetz1-120000*2-2200000),angle=90,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
...
#
       import simulationtrilayer
       reload(simulationtrilayer)
       Simulation=simulationtrilayer.Simulation
       ...
       Simulation.create(
           name='testtrio'+str(j),startfrequency=freqs1pk[j]-0.015,endfrequency=freqs1pk[j]+0.015,stepfrequency=2/300,
