...
for j in range(6):    
        ...
        Cgg=3.52e-15*2
        zlj1=1/(1j*wf*1e9*Cgg)+50
        #print("zl4.real: %s"%zl4.real)
        #print("zl4.imag: %s"%zl4.imag)
        
        arguj1=(zlj1-50)/(zlj1+50)
        #print("argu4.real: %s"%argu4.real)
        #print("argu4.imag: %s"%argu4.imag)
        
        phicj1=math.atan(arguj1.imag/arguj1.real)
        
        print("phicj1: %s" %phicj1)
        dcj1=-3e8*phicj1/(2*wf*math.sqrt(epsiloneff)) #electrical length of the interdigited capacitor
        print("dcj1: %s"%dcj1)
        #画腔
        ...
        def path3(painter):#设置内轮廓路径
            ...
            length+=painter.Turning(30000)
            length+=painter.Straight(cavitylen-dcj1-length)
            return length
...
#
        ...
        #5GHz to 7GHz
        Simulation.create(
            name='Rquccfine'+str(j),startfrequency=wf/(2*math.pi)-0.5,endfrequency=wf/(2*math.pi)+0.5,stepfrequency=1/300,
...
for j in range(6):    
        ...
        Cgg=3.52e-15*2
        zlj2=1/(1j*wf*1e9*Cgg)+50
        #print("zl4.real: %s"%zl4.real)
        #print("zl4.imag: %s"%zl4.imag)
        
        arguj2=(zlj2-50)/(zlj2+50)
        #print("argu4.real: %s"%argu4.real)
        #print("argu4.imag: %s"%argu4.imag)
        
        phicj2=math.atan(arguj2.imag/arguj2.real)
        
        print("phicj2: %s" %phicj2)
        dcj2=-3e8*phicj2/(2*wf*math.sqrt(epsiloneff)) #electrical length of the interdigited capacitor
        print("dcj2: %s"%dcj2)
        #画腔
        ...
        def path3(painter):#设置内轮廓路径
            ...
            length+=painter.Straight(150000)  
            length+=painter.Turning(30000*(-1))
            length+=painter.Straight(cavitylen-dcj2-length)
            return length
...
#
        ...
        Simulation.create(
            name='Rquccfine'+str(6+j),startfrequency=wf/(2*math.pi)-0.5,endfrequency=wf/(2*math.pi)+0.5,stepfrequency=1/300,
            layerlist=layerlist,boxx=530000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=[c4],portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy
            )
...
for j in range(6):    
        ...
        Cgg=3.52e-15*2
        zlj3=1/(1j*wf*1e9*Cgg)+50
        #print("zl4.real: %s"%zl4.real)
        #print("zl4.imag: %s"%zl4.imag)
        
        arguj3=(zlj3-50)/(zlj3+50)
        #print("argu4.real: %s"%argu4.real)
        #print("argu4.imag: %s"%argu4.imag)
        
        phicj3=math.atan(arguj3.imag/arguj3.real)
        
        print("phicj3: %s" %phicj3)
        dcj3=-3e8*phicj3/(2*wf*math.sqrt(epsiloneff)) #electrical length of the interdigited capacitor
        print("dcj3: %s"%dcj3)
        ...
        def path3(painter):#设置内轮廓路径
            ...
            length+=painter.Straight(150000)  
            length+=painter.Turning(30000*(-1))
            length+=painter.Straight(cavitylen-dcj3-length)
            return length
...
#
        ...
        Simulation.create(
            name='Rquccfine'+str(12+j),startfrequency=wf/(2*math.pi)-0.5,endfrequency=wf/(2*math.pi)+0.5,stepfrequency=1/300,
            layerlist=layerlist,boxx=530000,boxy=1607000+100000,
...
for j in range(6):    
        ...
        Cgg=3.52e-15*2
        zlj4=1/(1j*wf*1e9*Cgg)+50
        #print("zl4.real: %s"%zl4.real)
        #print("zl4.imag: %s"%zl4.imag)
        
        arguj4=(zlj4-50)/(zlj4+50)
        #print("argu4.real: %s"%argu4.real)
        #print("argu4.imag: %s"%argu4.imag)
        
        phicj4=math.atan(arguj4.imag/arguj4.real)
        
        print("phicj4: %s" %phicj4)
        dcj4=-3e8*phicj4/(2*wf*math.sqrt(epsiloneff)) #electrical length of the interdigited capacitor
        print("dcj4: %s"%dcj4)
        ...
        def path3(painter):#设置内轮廓路径
            ...
            length+=painter.Straight(150000)  
            length+=painter.Turning(30000*(1))
            length+=painter.Straight(cavitylen-dcj4-length)
            return length
...
#
        ...
        Simulation.create(
            name='Rquccfine'+str(18+j),startfrequency=wf/(2*math.pi)-0.5,endfrequency=wf/(2*math.pi)+0.5,stepfrequency=1/300,
            layerlist=layerlist,boxx=530000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=[c4],portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy
            )
