...
##
#BP Filter
wp=((7.01191+6.4463)/2-0.3)*2*math.pi #5.975 5.76
epsilonr=11.4
...
#print("dc1: %s"%dc1)
#print("Qf1: %s"%Qf1)
print("tapx1/lenp1: %s" %((math.asin(  math.sqrt(math.pi/4/Qf1)    ))  /(math.pi/2) ))

tapx1= ( 2*cavitylenp1* ( math.asin(  math.sqrt(math.pi/4/Qf1) ) ) )/math.pi
print("tap1: %s"%tapx1)
...
Simulation.create(name='halfwaveyrckofst'+str(1),startfrequency=2,endfrequency=10,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000+20000-468000+11000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
...
##
#BP Filter
wp=((7.01191+6.4463)/2 -0.3 )*2*math.pi #6.275 6.02
epsilonr=11.4
epsiloneff=(1+epsilonr)/2
...
print("Qf2: %s"%Qf2)
print("tapx2/lenp2: %s" %((math.asin(   math.sqrt(math.pi/4/Qf2)    ))  /(math.pi/2) ))

tapx2= ( 2*cavitylenp2* ( math.asin(    math.sqrt(math.pi/4/Qf2)    ) ) )/math.pi
print("tap2: %s"%tapx2)
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='halfwaveyrckofst'+str(2),startfrequency=2,endfrequency=10,stepfrequency=2/300,layerlist=layerlist,boxx=7400000,boxy=1076000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
...
##
#BP Filter
wp=((6.42491+6.98859)/2 -0.3 )*2*math.pi #6.575 6.28
epsilonr=11.4
epsiloneff=(1+epsilonr)/2
...
print("Qf3: %s"%Qf3)
print("tapx3/lenp3: %s" %((math.asin(    math.sqrt(math.pi/4/Qf3)    ))  /(math.pi/2)) )

tapx3= ( 2*cavitylenp3* ( math.asin(    math.sqrt(math.pi/4/Qf3) ) ) )/math.pi
print("tap3: %s"%tapx3)
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='halfwaveyrckofst'+str(3),startfrequency=2,endfrequency=10,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000+19000+12000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
...
##
#BP Filter
wp=((6.42491+6.98859)/2 -0.3 )*2*math.pi #6.875 6.54
epsilonr=11.4
epsiloneff=(1+epsilonr)/2
...
print("Qf4: %s"%Qf4)
print("tapx4/lenp4: %s" %((math.asin(   math.sqrt(math.pi/4/Qf4)    ))  /(math.pi/2)))

tapx4= ( 2*cavitylenp4* ( math.asin(   math.sqrt(math.pi/4/Qf4)   ) ) )/math.pi
print("tap4: %s"%tapx4)
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='halfwaveyrckofst'+str(4),startfrequency=2,endfrequency=10,stepfrequency=2/300,layerlist=layerlist,boxx=7400000,boxy=1076000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=0,absy=-1138000-dCkx)
#输出 
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
