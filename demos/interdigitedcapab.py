...
for j in range(5):
       ...
       #painter3.Run(path1)    
       painter3.InterdigitedCapacitor(2*j+1, arg1=3000+27.3*1000*2/3,arg2=45000,arg3=31000,arg4=4000,arg5=3000,arg6=3000,arg7=2000)
       ...
       portbrushs=[
            paintlib.CavityBrush(pointc=pya.DPoint(xx,465000-55000+0.3*1000 -27.3*1000*1/3),angle=0,widout=8000,widin=4000,bgn_ext=0),
       ...
       Simulation.create(
           name='intcapsc'+str(2*j+1),startfrequency=5,endfrequency=7,stepfrequency=2/300,
           layerlist=layerlist,boxx=150000,boxy=180000-5000-55000+0.3*1000 -27.3*1000*1/3,
           region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
           offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy-55000/2+0.3*1000/2 -27.3*1000*1/3/2
           )
