...
#
        ...
        Simulation.create(
            name='Rquyrfine'+str(j),startfrequency=6.45+j*0.0484-0.05,endfrequency=6.45+j*0.0484+0.05,stepfrequency=2/300,
...
#
        ...
        Simulation.create(
            name='Rquyrfine'+str(6+j),startfrequency=6.74+j*0.052-0.05,endfrequency=6.74+j*0.052+0.05,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=None,portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy+60000
            )
...
#
        ...
        Simulation.create(
            name='Rquyrfine'+str(12+j),startfrequency=6.424+j*0.05-0.05,endfrequency=6.424+j*0.05+0.05,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=None,portbrushs=None,
...
#
        ...
        Simulation.create(
            name='Rquyrfine'+str(18+j),startfrequency=6.724+j*0.0552-0.05,endfrequency=6.724+j*0.0552+0.05,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=None,portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy
            )
