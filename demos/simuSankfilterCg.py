...
for j in range(6):    
        ...
        painterCg=paintlib.CavityPainter(pya.DPoint(-2650000+j*500000,290000),angle=270,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
...
#####
portbrushs=[
    paintlib.CavityBrush(pointc=pya.DPoint(-47000,3006000),angle=0,widout=8000,widin=4000,bgn_ext=0),
...
Simulation.create(name='Sank'+str(j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000+20000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=-1633500+17000,absy=1895500-10000)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
#####
portbrushs=[
    paintlib.CavityBrush(pointc=pya.DPoint(47000,2758000),angle=0,widout=8000,widin=4000,bgn_ext=0),
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sank'+str(6+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=1633500-17000,absy=1771500-124000)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
#####
portbrushs=[
    paintlib.CavityBrush(pointc=pya.DPoint(-47000,-2533000),angle=0,widout=8000,widin=4000,bgn_ext=0),
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sank'+str(12+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=-1633500+17000,absy=-1605500+183000)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
#####
portbrushs=[
    paintlib.CavityBrush(pointc=pya.DPoint(47000,-2328000),angle=0,widout=8000,widin=4000,bgn_ext=0),
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sank'+str(18+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=1543000+34000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=1633500-16500,absy=-1583500+10000+34000)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
