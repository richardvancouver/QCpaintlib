...
Simulation.create(name='Sankbyrck'+str(j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000+20000-468000+11000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
...
#####
portbrushs=[
    paintlib.CavityBrush(pointc=pya.DPoint(47000,2338000+dCkx),angle=0,widout=8000,widin=4000,bgn_ext=0), #2758000
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankbyrck'+str(6+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000-431000+11000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=1633500-17000,absy=1771500-124000-431000/2+dCkx+11000/2)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankbyrck'+str(12+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000+19000+12000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
...
#####
portbrushs=[
    paintlib.CavityBrush(pointc=pya.DPoint(47000,-2351000-dCkx),angle=0,widout=8000,widin=4000,bgn_ext=0), #-2328000
    paintlib.CavityBrush(pointc=pya.DPoint(3266000,-1267000-dCkx),angle=0,widout=8000,widin=4000,bgn_ext=0), #-1207000
#    paintlib.CavityBrush(pointc=pya.DPoint(xx+0,yy+136000),angle=0,widout=8000,widin=4000,bgn_ext=0)
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankbyrck'+str(18+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=1543000+34000+13000+10000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=1633500-16500,absy=-1583500+10000+34000-13000/2-dCkx-10000/2)
#输出 
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
