...
for j in range(6):
    ...
    xx=pts[0].x+11000
    yy=pts[0].y+850000 #one side's distance to the center is longer than the other side, and the generated box is symmetric to the center, thus add some offsets to capture both sides, otherwise one side will be cutted and the other side will be missed
    #portbrushs=[
...
#
        ...
        Simulation.create(
            name='Rqu'+str(j),startfrequency=6,endfrequency=7,stepfrequency=1/300,
            layerlist=layerlist,boxx=530000,boxy=1607000,
...
#
        ...
        Simulation.create(
            name='Restest'+str(j+6),startfrequency=6,endfrequency=7,stepfrequency=1/300,
...
#
        ...
        Simulation.create(
            name='Restest'+str(j+12),startfrequency=6,endfrequency=7,stepfrequency=1/300,
            layerlist=layerlist,boxx=530000,boxy=1360000,
            region=painter3.region,brush=painter3p5.brush,transmissionlines=[c4],portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=None,absy=None
            )
...
#
        ...
        Simulation.create(
            name='Restest'+str(j+18),startfrequency=6,endfrequency=7,stepfrequency=1/300,
            layerlist=layerlist,boxx=530000,boxy=1360000,
            region=painter3.region,brush=painter3p5.brush,transmissionlines=[c4],portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=None,absy=None
            )
