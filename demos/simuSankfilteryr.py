...
Simulation.create(name='Sankbyr'+str(j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000+20000-468000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=-1633500+17000,absy=1895500-10000-468000/2)
#输出
print(TBD.isFinish())
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankbyr'+str(6+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000-431000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=1633500-17000,absy=1771500-124000-431000/2)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankbyr'+str(12+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000+19000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=-1633500+17000,absy=-1605500+183000-19000/2)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankbyr'+str(18+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=1543000+34000+13000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=1633500-16500,absy=-1583500+10000+34000-13000/2)
#输出 
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
