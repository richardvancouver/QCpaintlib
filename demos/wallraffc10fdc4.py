...
#
       ...
       Simulation.create(
           name='Wallraffc10fcbresnb'+str(j),startfrequency=freqs1pk[j]-0.015,endfrequency=freqs1pk[j]+0.015,stepfrequency=2/300,
           layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000 -1500000 -24000,
...
#################qubits sec2############
         ...
         portbrushs=[
             ...
             paintlib.CavityBrush(pointc=pya.DPoint(xx-261000+250000,yy-790000+4000 +24000),angle=0,widout=8000,widin=4000,bgn_ext=0),
             #paintlib.CavityBrush(pointc=pya.DPoint(xx+0,yy-136000),angle=0,widout=8000,widin=4000,bgn_ext=0)
...
#
        ...
        #boxy=1607000+100000, +-0.001
         Simulation.create(
            name='Wallraffc10fcbresnb'+str(6+j),startfrequency=freqs2[j]-0.5,endfrequency=freqs2[j]+0.5,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000 -1500000 -24000,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy+60000+900000-300000/2 -1500000/2+4000 +24000/2
            )
...
############merge before drawing####################               
  ...
  #################qubits sec3############
         ...
         portbrushs=[
              ...
              paintlib.CavityBrush(pointc=pya.DPoint(xx+2739000-2750000,yy+849500-4000 -24000),angle=0,widout=8000,widin=4000,bgn_ext=0),
              #paintlib.CavityBrush(pointc=pya.DPoint(xx+0,yy-136000),angle=0,widout=8000,widin=4000,bgn_ext=0)
  ...
  #
        ...
        #boxy=1607000+100000,
         Simulation.create(
            name='Wallraffc10fcbresnb'+str(12+j),startfrequency=freqs3[j]-0.5,endfrequency=freqs3[j]+0.5,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000 -1500000 -24000,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy-600000-300000+300000/2 +1500000/2-4500 -24000/2
            )
...
#################qubits sec4############
         ...
         portbrushs=[
            ...
            paintlib.CavityBrush(pointc=pya.DPoint(xx-261000+250000,yy+849500-4000-24000),angle=0,widout=8000,widin=4000,bgn_ext=0),
            #paintlib.CavityBrush(pointc=pya.DPoint(xx+0,yy-136000),angle=0,widout=8000,widin=4000,bgn_ext=0)
...
#
        ...
        #boxy=1607000+100000
         Simulation.create(
            name='Wallraffc10fcbresnb'+str(18+j),startfrequency=freqs4[j]-0.5,endfrequency=freqs4[j]+0.5,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000-1500000-24000,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy-600000-300000/2+1500000/2-4500 -24000/2
            )
