...
length=painterfeed1.Run(pathfeed)
brushfeed2=painterfeed1.brush ##record T position 2
###################################
...
length=painterfeed1.Run(pathfeed)
brushfeed3=painterfeed1.brush ##record T position 3
###################################
...
length=painterfeed1.Run(pathfeed)
brushfeed4=painterfeed1.brush ##record T position 4
###################################
...
painterfeeddn1=paintlib.CavityPainter(listbrush[0])
...
####make brush point down and go to the position###
painterfeeddn2=paintlib.CavityPainter(brushfeed2)
def pathturn1(painter):
    painter.Straight(50000)
    painter.Turning(50000,-270)
    painter.Straight(50000)
    
painterfeeddn2.Run(pathturn1)
brushfeeddn2b=painterfeeddn2.brush    
################################################

#####make the downward CPW segment###############
painterfeeddn2b=paintlib.CavityPainter(brushfeeddn2b)

def pathfeeddn1(painter):
    painter.Straight(50000)

painterfeeddn2b.Run(pathfeeddn1)
#####################################
...
####make brush point down and go to the position###
painterfeeddn3=paintlib.CavityPainter(brushfeed3)
def pathturn1(painter):
    painter.Straight(50000)
    painter.Turning(50000,-270)
    painter.Straight(50000)
    
painterfeeddn3.Run(pathturn1)
brushfeeddn3b=painterfeeddn3.brush    
################################################

#####make the downward CPW segment###############
painterfeeddn3b=paintlib.CavityPainter(brushfeeddn3b)

def pathfeeddn1(painter):
    painter.Straight(50000)

painterfeeddn3b.Run(pathfeeddn1)
#####################################
...
####################################################combine the segments
painterfeed1.regionlistout.extend(painterfeeddn2b.regionlistout) #list action, extend the list of painter3
painterfeed1.regionlistin.extend(painterfeeddn2b.regionlistin)

####################################################

####################################################combine the segments
painterfeed1.regionlistout.extend(painterfeeddn3b.regionlistout) #list action, extend the list of painter3
painterfeed1.regionlistin.extend(painterfeeddn3b.regionlistin)
