...
painterfeed1=paintlib.CavityPainter(pya.DPoint(-3200000,3100000+offsetz1),angle=0,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
...
for j in range(6):    
      ...
      # #painter3.painterout.Turning=painter3.painterout.TurningInterpolation
       ...
       painterc2.InterdigitedCapacitor(2*1+1, arg1=3000+27.3*1000*2/3,arg2=45000,arg3=31000,arg4=4000,arg5=3000,arg6=3000,arg7=2000)
      ...
      # #print("length of resonator1 : %s"%(length))
       ...
       painter3=paintlib.CavityPainter(pya.DPoint(-2650000+j*500000+67500,290000+1308000+offsetz1),angle=180,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
       painter3plus=paintlib.CavityPainter(pya.DPoint(-2650000+j*500000+67500,290000+1308000+offsetz1),angle=0,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
...
#################qubits sec1############
       ...
       portbrushs=[
            paintlib.CavityBrush(pointc=pya.DPoint(xx+2739000 -3004000,yy-790000+3400000),angle=0,widout=8000,widin=4000,bgn_ext=0),
            paintlib.CavityBrush(pointc=pya.DPoint(xx+2739000 -2496000 ,yy-790000+3400000),angle=0,widout=8000,widin=4000,bgn_ext=0),
...
#
       ...
       Simulation.create(
           name='Wallraffce'+str(j),startfrequency=freqs1[j]-0.001,endfrequency=freqs1[j]+0.001,stepfrequency=2/300,
           layerlist=layerlist,boxx=530000-22000,boxy=1750000*2,
           region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
           offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy+60000+900000
           )
...
##############start the feedline backbone#############################################
painterfeed1=paintlib.CavityPainter(pya.DPoint(3200000,3100000+offsetz1),angle=180,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
...
for j in range(6):    
        ...
        # #painter3.painterout.Turning=painter3.painterout.TurningInterpolation
         ...
         painterc2=paintlib.CavityPainter(brushupb)
         painterc2.Run(pathup)
         painterc2.InterdigitedCapacitor(2*1+1, arg1=3000+27.3*1000*2/3*0.8125*2.6/2.9,arg2=45000,arg3=31000,arg4=4000,arg5=3000,arg6=3000,arg7=2000)
...
######        
       ...
       ######flipped resonator2#####
         ...
         painter3=paintlib.CavityPainter(pya.DPoint(150000+j*500000-67500,290000+1308000+offsetz1),angle=0,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
         painter3plus=paintlib.CavityPainter(pya.DPoint(150000+j*500000-67500,290000+1308000+offsetz1),angle=180,widout=8000,widin=4000,bgn_ext=000,end_ext=0000)
...
#################qubits sec2############
         ...
         yy=pts[0].y+850000-200000 #one side's distance to the center is longer than the other side, and the generated box is symmetric to the center, thus add some offsets to capture both sides, otherwise one side will be cutted and the other side will be missed
         portbrushs=[
             paintlib.CavityBrush(pointc=pya.DPoint(xx-261000-4000,yy-790000+3400000),angle=0,widout=8000,widin=4000,bgn_ext=0),
             paintlib.CavityBrush(pointc=pya.DPoint(xx-261000+504000,yy-790000+3400000),angle=0,widout=8000,widin=4000,bgn_ext=0),
             #paintlib.CavityBrush(pointc=pya.DPoint(xx+0,yy-136000),angle=0,widout=8000,widin=4000,bgn_ext=0)
...
#
        ...
        #boxy=1607000+100000,
         Simulation.create(
            name='Wallraffce'+str(6+j),startfrequency=freqs2[j]-0.001,endfrequency=freqs2[j]+0.001,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy+60000+900000
            )
...
############merge before drawing####################               
  ...
  #
        ...
        #boxy=1607000+100000,
         Simulation.create(
            name='Wallraffce'+str(12+j),startfrequency=freqs3[j]-0.001,endfrequency=freqs3[j]+0.001,stepfrequency=2/300,
...
#
        ...
        #boxy=1607000+100000
         Simulation.create(
            name='Wallraffce'+str(18+j),startfrequency=freqs4[j]-0.001,endfrequency=freqs4[j]+0.001,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
