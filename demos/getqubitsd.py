...
for j in range(6):
   ...
   # the claw, Cg
    ...
    Simulation.create(
        name='Qutestgetd'+str(j),startfrequency=6,endfrequency=7,stepfrequency=0.1/300,
...
#   # the claw, Cg
    ...
    Simulation.create(
        name='Qutestgetd'+str(6+j),startfrequency=6,endfrequency=7,stepfrequency=0.1/300,
        layerlist=layerlist,boxx=530000,boxy=286000,
        region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
        offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy
        )
...
#       # the claw, Cg
    ...
    Simulation.create(
        name='Qutestgetd'+str(12+j),startfrequency=6,endfrequency=7,stepfrequency=0.1/300,
        layerlist=layerlist,boxx=530000,boxy=286000,
        region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
        offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy
        )
...
#       # the claw, Cg
    ...
    Simulation.create(
        name='Qutestgetd'+str(18+j),startfrequency=6,endfrequency=7,stepfrequency=0.1/300,
        layerlist=layerlist,boxx=530000,boxy=286000,
        region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
        offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy
        )
