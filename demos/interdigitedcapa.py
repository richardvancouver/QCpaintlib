...
for j in range(5):
       ...
       #painter3.Run(path1)    
       painter3.InterdigitedCapacitor(2*j+1)
       ...
       portbrushs=[
            paintlib.CavityBrush(pointc=pya.DPoint(xx,465000),angle=0,widout=8000,widin=4000,bgn_ext=0),
       ...
       Simulation.create(
           name='intcaps'+str(2*j+1),startfrequency=5,endfrequency=7,stepfrequency=2/300,
           layerlist=layerlist,boxx=150000,boxy=180000-5000,
