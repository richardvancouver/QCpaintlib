...
Simulation.create(name='Sankb'+str(j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000+20000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankb'+str(6+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankb'+str(12+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=2221000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='Sankb'+str(18+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=3300000,boxy=1543000+34000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
