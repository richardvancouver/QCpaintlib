...
#################qubits sec1############
       ...
       portbrushs=[
            ...
            paintlib.CavityBrush(pointc=pya.DPoint(xx+2739000 -2750000 ,yy-790000+4000  ),angle=0,widout=8000,widin=4000,bgn_ext=0),
...
#
       ...
       Simulation.create(
           name='Wallraffc10fcbresn'+str(j),startfrequency=freqs1pk[j]-0.015,endfrequency=freqs1pk[j]+0.015,stepfrequency=2/300,
           layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000 -1500000,
           region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
           offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy+60000+900000-300000/2 -1500000/2+4000
           )
...
#################qubits sec2############
         ...
         painter1=paintlib.TransfilePainter("C:/Users/Rui/Desktop/g/sqc-painter/Qubit-24bitv2cmirrord.gds")#Qubit-24bitv2cmirror  Qubit-24bitv2cmirror Qubit-24bitv2cmirror2

         pts=[pya.Point(250000+j*500000,140000)]
         xx=pts[0].x+11000
         yy=pts[0].y+850000-200000 #one side's distance to the center is longer than the other side, and the generated box is symmetric to the center, thus add some offsets to capture both sides, otherwise one side will be cutted and the other side will be missed
         portbrushs=[
             paintlib.CavityBrush(pointc=pya.DPoint(xx-261000+157.25*1000,yy-790000+1704000),angle=0,widout=8000,widin=4000,bgn_ext=0),
             paintlib.CavityBrush(pointc=pya.DPoint(xx-261000+250000,yy-790000+4000 ),angle=0,widout=8000,widin=4000,bgn_ext=0),
             #paintlib.CavityBrush(pointc=pya.DPoint(xx+0,yy-136000),angle=0,widout=8000,widin=4000,bgn_ext=0)
...
#
        ...
        #boxy=1607000+100000, +-0.001
         Simulation.create(
            name='Wallraffc10fcbresn'+str(6+j),startfrequency=freqs2[j]-0.5,endfrequency=freqs2[j]+0.5,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000 -1500000,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy+60000+900000-300000/2 -1500000/2+4000
            )
...
############merge before drawing####################               
  ...
  #################qubits sec3############
         ...
         painter1=paintlib.TransfilePainter("C:/Users/Rui/Desktop/g/sqc-painter/Qubit-24bitv2cm3d.gds") #Qubit-24bitv2cm3  Qubit-24bitv2cm3nb Qubit-24bitv2cm32
         ...
         portbrushs=[
              paintlib.CavityBrush(pointc=pya.DPoint(xx+2739000-2657.25*1000,yy+849500-1704000),angle=0,widout=8000,widin=4000,bgn_ext=0),
              paintlib.CavityBrush(pointc=pya.DPoint(xx+2739000-2750000,yy+849500-4000),angle=0,widout=8000,widin=4000,bgn_ext=0),
              #paintlib.CavityBrush(pointc=pya.DPoint(xx+0,yy-136000),angle=0,widout=8000,widin=4000,bgn_ext=0)
  ...
  #
        ...
        #boxy=1607000+100000,
         Simulation.create(
            name='Wallraffc10fcbresn'+str(12+j),startfrequency=freqs3[j]-0.5,endfrequency=freqs3[j]+0.5,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000 -1500000,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy-600000-300000+300000/2 +1500000/2-4500
            )
...
#################qubits sec4############
         ...
         painter1=paintlib.TransfilePainter("C:/Users/Rui/Desktop/g/sqc-painter/Qubit-24bitv2cmirrorbd.gds") #Qubit-24bitv2cmirrorb Qubit-24bitv2cmirrorbnb Qubit-24bitv2cmirrorb2

         pts=[pya.Point(250000+j*500000,-140000-14000)]
         xx=pts[0].x+11000
         yy=pts[0].y-850000+200000-45.5*1000 #one side's distance to the center is longer than the other side, and the generated box is symmetric to the center, thus add some offsets to capture both sides, otherwise one side will be cutted and the other side will be missed
         portbrushs=[
            paintlib.CavityBrush(pointc=pya.DPoint(xx-261000+157.25*1000,yy+849500-1704000),angle=0,widout=8000,widin=4000,bgn_ext=0),
            paintlib.CavityBrush(pointc=pya.DPoint(xx-261000+250000,yy+849500-4000),angle=0,widout=8000,widin=4000,bgn_ext=0),
            #paintlib.CavityBrush(pointc=pya.DPoint(xx+0,yy-136000),angle=0,widout=8000,widin=4000,bgn_ext=0)
...
#
        ...
        #boxy=1607000+100000
         Simulation.create(
            name='Wallraffc10fcbresn'+str(18+j),startfrequency=freqs4[j]-0.5,endfrequency=freqs4[j]+0.5,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000-1500000,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy-600000-300000/2+1500000/2-4500
            )
