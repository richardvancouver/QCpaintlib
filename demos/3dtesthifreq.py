...
#########resonator sec1############
for j in range(6):    
        wf=(6.425-0.025-0.025+0.04*j )*2*math.pi #p110 of sank: wf/2pi=6.75GHz 5.85
        epsilonr=11.4
...
#
        ...
        Simulation.create(
            name='Rquh'+str(j),startfrequency=5,endfrequency=7,stepfrequency=2/300,
...
###################section 2#################
for j in range(6):    
        wf=(6.665-0.025-0.025+0.04*j )*2*math.pi #p110 of sank: wf/2pi=6.75GHz
        epsilonr=11.4
        epsiloneff=(1+epsilonr)/2
        print("pi: %s" %(math.pi))
        print("sqrt: %s" %(math.sqrt(1.44)))
...
#
        ...
        Simulation.create(
            name='Rquh'+str(6+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=[c4],portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy
            )
...
###################section 3#################
for j in range(6):    
        wf=(6.905-0.025-0.025+0.04*j )*2*math.pi #p110 of sank: wf/2pi=6.75GHz
        epsilonr=11.4
        epsiloneff=(1+epsilonr)/2
        print("pi: %s" %(math.pi))
        print("sqrt: %s" %(math.sqrt(1.44)))
...
#
        ...
        Simulation.create(
            name='Rquh'+str(12+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=[c4],portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy
            )
...
###################section 4#################
for j in range(6):    
        wf=(7.145-0.025-0.025+0.04*j )*2*math.pi #p110 of sank: wf/2pi=6.75GHz
        epsilonr=11.4
        epsiloneff=(1+epsilonr)/2
        print("pi: %s" %(math.pi))
        print("sqrt: %s" %(math.sqrt(1.44)))
...
#
        ...
        Simulation.create(
            name='Rquh'+str(18+j),startfrequency=5,endfrequency=7,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=[c4],portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx,absy=yy
            )
