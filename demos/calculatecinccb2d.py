...
tail_fraction1r=0.160
tail_fraction1f=0.160
cin=[]
cc=[]
for j in range(6):    
      ...
      # print("sqrt: %s" %(math.sqrt(1.44)))
       ...
       ccwfc=2*JJ/(2*math.pi)*1e6/( math.sin( math.pi/2*tail_fraction1r )*math.sin( math.pi/2*tail_fraction1f ) )/(   math.sqrt( (wf*1e9*(wf*1e9-Dff*1e6) )/(cc1*cc2)  )   )
...
tail_fraction2r=0.165
tail_fraction2f=0.185
for j in range(6):    
      ...
      # print("sqrt: %s" %(math.sqrt(1.44)))
       ...
       cc1=math.pi/(4* wf/(2*math.pi)*1e9  *50)
       cc2=math.pi/(4* (wf/(2*math.pi)*1e9- Dff/(2*math.pi)*1e6 )  *50)
       ccwfc=2*JJ/(2*math.pi)*1e6/( math.sin( math.pi/2*tail_fraction2r )*math.sin( math.pi/2*tail_fraction2f ) )/(   math.sqrt( (wf*1e9*(wf*1e9-Dff*1e6) )/(cc1*cc2)  )   )
...
tail_fraction3r=0.149
tail_fraction3f=0.153
for j in range(6):    
      ...
      # print("sqrt: %s" %(math.sqrt(1.44)))
       ...
       cc1=math.pi/(4* wf/(2*math.pi)*1e9  *50)
       cc2=math.pi/(4* (wf/(2*math.pi)*1e9- Dff/(2*math.pi)*1e6 )  *50)
       ccwfc=2*JJ/(2*math.pi)*1e6/( math.sin( math.pi/2*tail_fraction3r )*math.sin( math.pi/2*tail_fraction3f  ) )/(   math.sqrt( (wf*1e9*(wf*1e9-Dff*1e6) )/(cc1*cc2)  )   )
...
tail_fraction4r=0.153
tail_fraction4f=0.173
for j in range(6):    
      ...
      # print("sqrt: %s" %(math.sqrt(1.44)))
       ...
       cc1=math.pi/(4* wf/(2*math.pi)*1e9  *50)
       cc2=math.pi/(4* (wf/(2*math.pi)*1e9- Dff/(2*math.pi)*1e6 )  *50)
       ccwfc=2*JJ/(2*math.pi)*1e6/ ( math.sin( math.pi/2*tail_fraction4r )*math.sin( math.pi/2*tail_fraction4f ) ) /(   math.sqrt( (wf*1e9*(wf*1e9-Dff*1e6) )/(cc1*cc2)  )   )
