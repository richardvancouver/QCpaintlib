...
#
        ...
        Simulation.create(
            name='Rquyrfinedb'+str(j),startfrequency=freqs1[j]-0.001,endfrequency=freqs1[j]+0.001,stepfrequency=2/300,
...
#
        ...
        Simulation.create(
            name='Rquyrfinedb'+str(6+j),startfrequency=freqs2[j]-0.001,endfrequency=freqs2[j]+0.001,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=None,portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy+60000
            )
...
#
        ...
        Simulation.create(
            name='Rquyrfinedb'+str(12+j),startfrequency=freqs3[j]-0.001,endfrequency=freqs3[j]+0.001,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=None,portbrushs=None,
...
#
        ...
        Simulation.create(
            name='Rquyrfinedb'+str(18+j),startfrequency=freqs4[j]-0.001,endfrequency=freqs4[j]+0.001,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1607000+100000,
            region=None,brush=painter3p5.brush,transmissionlines=None,portbrushs=None,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy
            )
