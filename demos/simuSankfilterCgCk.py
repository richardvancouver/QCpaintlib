...
for j in range(6):    
        ...
        def path3(painter):#设置内轮廓路径
            ...
            length+=painter.Straight(150000+Ckl)  
            length+=painter.Turning(30000)
            length+=painter.Straight(cavitylen-length-Ckl)
            return length
...
offsetx=0,offsety=0,deltaangle=0,absx=-1633500+17000,absy=1895500-10000+dCkx)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
offsetx=0,offsety=0,deltaangle=0,absx=1633500-17000,absy=1771500-124000+dCkx)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
offsetx=0,offsety=0,deltaangle=0,absx=-1633500+17000,absy=-1605500+183000-dCkx)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
offsetx=0,offsety=0,deltaangle=0,absx=1633500-16500,absy=-1583500+10000+34000-dCkx)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
