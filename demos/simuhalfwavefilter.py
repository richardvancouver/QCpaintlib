...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='halfwaveyrck'+str(2),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=7400000,boxy=1800000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=0,absy=1576000+dCkx)
#输出
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
#paintlib.IO.Write()#输出到文件中
...
# paintlib.Interactive.cut(layerlist=layerlist,layermod='in',box=box)
#Simulation.resonator_transmissionline(painter5.region,painter5.brush,layerlist,500000,500000,'TBD_projectname',4,8,4,0)
Simulation.create(name='halfwaveyrck'+str(4),startfrequency=5,endfrequency=7,stepfrequency=2/300,layerlist=layerlist,boxx=7400000,boxy=1800000,region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
offsetx=0,offsety=0,deltaangle=0,absx=0,absy=-1576000-dCkx)
#输出 
print(TBD.isFinish())
paintlib.IO.Show()#输出到屏幕上
