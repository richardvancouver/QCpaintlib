...
#
       ...
       Simulation.create(
           name='Wallraffcd'+str(j),startfrequency=freqs1[j]-0.001,endfrequency=freqs1[j]+0.001,stepfrequency=2/300,
...
#
        ...
        #boxy=1607000+100000,
         Simulation.create(
            name='Wallraffcd'+str(6+j),startfrequency=freqs2[j]-0.001,endfrequency=freqs2[j]+0.001,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
            offsetx=0,offsety=0,deltaangle=0,absx=xx-22000/2,absy=yy+60000+900000
            )
...
############merge before drawing####################               
  ...
  #
        ...
        #boxy=1607000+100000,
         Simulation.create(
            name='Wallraffcd'+str(12+j),startfrequency=freqs3[j]-0.001,endfrequency=freqs3[j]+0.001,stepfrequency=2/300,
...
#
        ...
        #boxy=1607000+100000
         Simulation.create(
            name='Wallraffcd'+str(18+j),startfrequency=freqs4[j]-0.001,endfrequency=freqs4[j]+0.001,stepfrequency=2/300,
            layerlist=layerlist,boxx=530000-22000,boxy=1750000*2-300000,
            region=None,brush=None,transmissionlines=None,portbrushs=portbrushs,
